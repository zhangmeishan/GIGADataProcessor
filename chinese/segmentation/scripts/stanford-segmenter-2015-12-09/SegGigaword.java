...
public class SegGigaword {

	private static final String basedir = System.getProperty("SegGigaword", "data");
	...
	public static void main(String[] args) throws Exception {
		...
		for (String file_name : file_list) {
			...
			BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(input_file_name),"UTF-8"));
			BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(output_file_name),"UTF-8"));
